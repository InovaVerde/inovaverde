      ...
      <div>
        ...
        {show && (
          <div className="absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-90 z-50">
            <div
              className="xl:w-1/2 w-full border-2 h-full bg-black bg-opacity-90 overflow-y-auto overflow-x-hidden fixed top-0 right-0 bottom-0"
              id="chec-div"
            >
              <div
              ...
              >
                <div
                  className="flex flex-col md:flex-row justify-end h-full"
                  id="cart"
                >
                  <div
                    className="xl:w-full lg:w-full md:w-2/3 w-full md:pl-10 pl-4 pr-10 md:pr-4 md:py-12 py-8 bg-white overflow-y-auto overflow-x-hidden h-full"
                    id="scroll"
                  >
                    <div
                  ...
                  <div className="xl:w-1/2 md:w-1/3 w-full bg-green-100 h-full">
                    <div className="flex flex-col md:h-full px-14 py-20 justify-between overflow-y-auto">
                      <div>
